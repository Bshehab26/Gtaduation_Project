    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        @livewire('components.event-created')
                    </div><!-- End Sales Card -->

                    <!-- Revenue Card -->
                    <div class="col-xxl-4 col-md-6">
                        @livewire('components.tickets-booked')
                    </div><!-- End Revenue Card -->

                    <!-- Students Card -->
                    <div class="col-xxl-4 col-xl-12">
                        @livewire('components.users-number')
                    </div><!-- End Students Card -->

                    <div class="col-12">
                        @livewire('components.booking-table')
            ...
            <div class="col-lg-4">
                ...
                <!-- Recent Activity -->
                <div class="card">
                    @livewire('components.recent-activities')
                </div>
                <!-- End Recent Activity -->
