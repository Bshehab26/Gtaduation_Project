...
@push('styles')
    <style>
    .pagination {
        --bs-pagination-active-bg: #f82249;
        --bs-pagination-active-border-color: #f82249;
        --bs-link-color: #0e1b4d;
        --bs-link-hover-color: #0e1b4d;
        --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgb(248, 34, 73, 0.25);
    }
    </style>
@endpush
